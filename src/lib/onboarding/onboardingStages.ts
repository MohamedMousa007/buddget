  ...
  const rows: OnboardingStageRow[] = [
    {
      ...
      description: 'Name, country, and city',
      status: personal ? 'complete' : 'pending',
    },
    {
      id: 'income',
      label: 'Income',
      description: 'Recurring income or survey income step',
      status: income ? 'complete' : 'pending',
    },
    {
      id: 'costs',
      label: 'Housing & spending',
      description: 'Housing, subscriptions, or category budgets',
      status: costs ? 'complete' : 'pending',
    },
    {
      id: 'debts',
      label: 'Debts',
      description: 'Debts in the app or survey',
      status: debtsDone ? 'complete' : 'pending',
    },
    {
      id: 'lifestyle',
      label: 'Goals & habits',
      description: 'Goals, spending style, and related survey answers',
      status: lifestyle ? 'complete' : 'pending',
    },
    {
      id: 'payments',
      label: 'Payment methods',
      description: 'Survey payment step or custom methods',
      status: payments ? 'complete' : 'pending',
    },
    {
      id: 'plan',
      label: 'Budget plan',
      description: 'Accepted AI plan or finished manual setup',
