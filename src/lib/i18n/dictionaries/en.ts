...
export const en: Dictionary = {
  ...
  smsTracking: {
    ...
    iosStepInstallTitle: 'Install the Shortcut',
    iosStepInstallDesc: 'Tap below — Safari opens the Shortcuts app and asks you to add "Buddget SMS Tracker".',
    iosStepKeywordsTitle: 'Copy Trigger Keywords',
    iosStepKeywordsDesc: 'These words tell iOS which bank messages to forward. Copy them for the next step.',
    iosCopyKeywords: 'Copy Trigger Keywords',
    iosCopiedKeywords: 'Copied!',
    iosStepAutomationTitle: 'Create the Automation',
    iosStepAutomationDesc: 'In Shortcuts → Automation → New, choose "When I receive a Message containing" and paste the keywords. Set the action to Run "Buddget SMS Tracker", then turn Run Immediately ON and Ask Before Running OFF.',
    iosDownloadButton: 'Download iOS Shortcut',
    iosDownloading: 'Preparing shortcut\u2026',
    ...
    recentTitle: 'Recent auto-tracked transactions',
    recentEmpty: 'No auto-tracked transactions yet.',
    recentUndo: 'Undo',
    recentUndoSuccess: 'Transaction removed.',
    recentUndoExpired: 'Undo window has expired (5 min limit).',
    recentViewExpense: 'View',
    failure: {
      gemini_error: 'Skipped: AI service error',
      not_transaction: 'Skipped: Not a transaction',
      null_amount: 'Skipped: No amount detected',
      low_confidence: 'Saved as draft: Low AI confidence',
      duplicate: 'Skipped: Detected as duplicate',
      log_insert_failed: 'Skipped: Could not save',
      parse_exception: 'Skipped: Parsing error',
      processing: 'Processing…',
      rate_limited: 'Skipped: Daily limit reached',
      not_configured: 'Skipped: AI not configured',
      unknown: 'Skipped',
    },
    supportedBanksTitle: 'Supported banks & services',
    tokenRotateButton: 'Rotate token',
    tokenRotateConfirm: 'Rotating will invalidate your current iOS Shortcut and Android Bridge. You will need to re-download them. Continue?',
    tokenRotateSuccess: 'Token rotated. Please re-download your shortcut.',
  },
