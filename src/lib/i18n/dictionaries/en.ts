...
export const en: Dictionary = {
  ...
  income: {
    ...
    markDateReceived: (date) => `Mark ${date} as received`,
    editDateAmount: (date) => `Edit ${date} amount`,
    ...
    logMissedPayday: (date) => `Log missed ${date}`,
    ...
    assignConfirm: (source, date) => `Assign to ${source} \u00b7 ${date}`,
