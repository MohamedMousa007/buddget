...
export const en: Dictionary = {
  ...
  smsTracking: {
    ...
    iosStepCheckTitle: 'Check your setup',
    iosStepCheckDesc: 'One tap, no test texts needed \u2014 we ping our servers exactly the way your automation will.',
    iosCheckSetupButton: 'Check my setup',
    iosCheckChecking: 'Checking\u2026',
    iosCheckTokenSaved: 'Token saved on this device',
    iosCheckServerReachable: 'Buddget servers reachable',
    iosCheckTokenValid: 'Token valid',
    iosCheckFailedToken: 'No token saved yet \u2014 toggle SMS tracking off and on, then retry.',
    iosCheckFailedNetwork: 'Couldn\u2019t reach Buddget \u2014 check your connection and retry.',
    iosCheckFailedAuth: 'Token rejected \u2014 rotate the token below, then retry.',
    iosLastCatch: (time: string) => `Last catch: ${time}`,
    iosLastCatchWaiting: 'Waiting for your first bank text\u2026',
    iosLastCatchFailed: 'Last delivery failed \u2014 run the check above.',
    iosWalkthroughPrev: 'Back',
    iosWalkthroughNext: 'Next',
    iosWalkthroughStep: (current: number, total: number) => `Step ${current} of ${total}`,
