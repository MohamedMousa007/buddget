...
export const en: Dictionary = {
  ...
  smsTracking: {
    ...
    iosCardSubtitle: 'One-time setup via the iOS Shortcuts app.',
    iosCardStep1: '1. Tap "Download Shortcut" below.',
    iosCardStep2: '2. iOS will open the Shortcuts app — tap "Add Shortcut".',
    iosCardStep3: '3. Open Shortcuts → Automation → tap the Buddget shortcut → enable "Run Immediately".',
    iosCardStep4: '4. Done — all bank SMS will auto-forward to Buddget.',
    iosDownloadButton: 'Download Shortcut',
