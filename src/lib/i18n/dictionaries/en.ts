...
export const en: Dictionary = {
  ...
  expenses: {
    ...
    spentYesterday: 'Spent yesterday',
    ...
    periodFrom: 'From',
    periodTo: 'To',
    emptyInRange: 'Nothing logged in this period.',
    ...
    badgeNotCounted: 'Not counted toward spending',
    swipeDelete: 'Delete',
  ...
  income: {
    ...
    bracketDaysLate: (days: number) => (days === 1 ? '(+1 day)' : `(+${days} days)`),
    daysLateChip: (days: number) => (days === 1 ? '1 day late' : `${days} days late`),
  ...
  addIncome: {
    ...
    paydayEditBtn: 'Edit',
    driftLabel: 'Payday accuracy',
    driftHelper: 'How many days a paycheck may land from its payday',
    driftExact: 'On time',
    driftWeek: 'Up to a week',
    driftLoose: 'Whenever',
  ...
  subscriptions: {
    ...
    planChangeUpgrade: '{brand} looks like it moved up to {plan} — update?',
    planChangeDowngrade: '{brand} looks like it moved to {plan} — update?',
    planChangeApply: 'Update plan',
