  ...
  smsTracking: {
    ...
    guide: {
      ...
      steps: [
        ...
        { title: 'Think of a keyword', desc: 'First pick a word your bank *always* includes in its SMS — usually the currency. You’ll type it on the next screen.' },
        ...
        { title: "You're all set", desc: 'Each keyword only catches SMS that contain it. A 2nd automation with another keyword (e.g. *USD* or *جنيه*) catches messages worded differently — so nothing slips through.' },
      ],
    },
  },
