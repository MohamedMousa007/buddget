...
export const ar: Dictionary = {
  ...
  smsTracking: {
    ...
    iosCardSubtitle: 'إعداد لمرة واحدة عبر تطبيق Shortcuts.',
    iosCardStep1: '١. اضغط على "تنزيل الاختصار" أدناه.',
    iosCardStep2: '٢. سيفتح iOS تطبيق Shortcuts — اضغط "إضافة اختصار".',
    iosCardStep3: '٣. افتح Shortcuts ← Automation ← اضغط اختصار Buddget ← فعّل "تشغيل فوري".',
    iosCardStep4: '٤. تم — ستُعاد توجيه رسائل البنوك تلقائياً.',
