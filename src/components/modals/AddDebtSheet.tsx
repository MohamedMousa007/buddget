...
export function AddDebtSheet() {
  ...
  const newDebtSharedProps = {
    ...
    installmentProviderName: d.installmentProviderName,
    setInstallmentProviderName: d.setInstallmentProviderName,
    installmentProviderSlug: d.installmentProviderSlug,
    setInstallmentProviderSlug: d.setInstallmentProviderSlug,
