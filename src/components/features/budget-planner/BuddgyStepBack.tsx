...
const ghostBackClass =
  'cursor-pointer rounded-xl border border-transparent px-4 py-2.5 text-sm font-medium text-[var(--color-brand-text-secondary)] hover:text-[var(--color-brand-text-primary)] hover:bg-[var(--color-brand-text-primary)]/5 transition-colors'
